...
<p class='codepen' data-height='400' data-theme-id='light' data-default-tab='result' data-preview='true' data-user='sfi0zy' data-slug-hash='zYZQJJV' style='height: 400px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;' data-pen-title='Lines + Mouse (WebGL example)'>
