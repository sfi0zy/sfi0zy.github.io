...
We [continue to examine the fragment shaders](https://habr.com/post/421821/). The Voronoi diagram, pixelation and masks are on the agenda today.

{% include codepen.html hash="VGmEYN" %}
